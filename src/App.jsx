...
const PortfolioSection = () => {
  ...
  const allProjects = [
    ...
    { id: 'optracks', title: 'OP Tracker', desc: lang === 'id' ? 'Platform <strong>pelacakan progres</strong> anime <strong>One Piece</strong> premium tanpa login, dilengkapi <strong>filter filler</strong>, navigasi <strong>saga & arc</strong> lengkap, serta sistem <strong>rank bajak laut</strong> yang interaktif.' : 'Premium <strong>anime progress tracker</strong> for <strong>One Piece</strong> without login, featuring <strong>filler filter</strong>, complete <strong>saga & arc</strong> navigation, and an interactive <strong>pirate rank</strong> system.', url: 'https://optracks.vercel.app' },
