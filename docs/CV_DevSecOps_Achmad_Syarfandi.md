# Achmad Syarfandi
**Senior DevOps Engineer | Cloud Infrastructure & Security Specialist**
...
Highly analytical and self-driven **DevOps Engineer** with over 8 years of experience in architecting resilient cloud infrastructures and automating security-first CI/CD pipelines. Expert in **Infrastructure as Code (Terraform)** and **Kubernetes (K8s)** orchestration, with a proven track record of scaling enterprise ecosystems and government-scale platforms. Adept at working in **asynchronous environments** and collaborating across **global time zones**. Committed to high-quality technical documentation and building scalable, secure, and highly available systems.
...
*2025 – Present | Makassar, Indonesia (Hybrid/Remote)*
...
- **Automated** deployment pipelines for government web services using **GitHub Actions**, achieving a 40% reduction in deployment-related downtime.
- **Maintained** the official Government Email Server, ensuring 99.99% availability and robust anti-spam/security filtering.

### Lead DevOps Engineer | GetKasir (Enterprise POS Startup)
...
- **Orchestrated** cloud staging and production environments, reducing infrastructure costs by 25% through resource optimization and serverless utilization.

---

## Technical Projects
- **Kawan Sedarah**: Built a real-time blood stock command center platform using Supabase and React, used for regional emergency response.
- **Asisten Virtual AI**: Integrated cutting-edge LLMs and Voice AI (Simli) with automated deployment workflows.
